...
Пароль  - набор символов, который вы задаёте (придумываете) сами. Установить его возможно из письма-приглашения или по ссылке [https://2026.flow.tgu-dpo.ru/Account/ForgotPassword](https://2026.flow.tgu-dpo.ru/Account/ForgotPassword)
